        ...
        <div className="container-fluid d-flex h-100 flex-column">
          <div className="row flex-grow-1">
            <div className="col-xl">
                <Link to={`/bossRoom/${playerId}`} className="btn btn-danger" id="fightLink"> Fight </Link>
            ...
            <div id="examineDetails">
              <p>
                  ...
                  <br/>
                  <br/>
                  You see a bird with a crown. This must be some kind of boss.
                  <br/>
                  This won't be easy.
              </p>
            </div>
